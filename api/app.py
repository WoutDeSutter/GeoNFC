...
# from .database import Database # Commented out database import
# from .scheduler import init_scheduler # Scheduler already commented
import os

print("Flask application starting...") # Added print statement
...
# API Routes
# Comment out all API routes that use the database
...
#     return jsonify({'error': 'Database disabled'}), 500
